  ...
  <body class="font-sans text-gray-800">
    ...
    <section class="relative bg-gradient-to-r from-green-50 via-green-100 to-green-50 py-20 overflow-hidden">
      <div class="max-w-4xl mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-extrabold text-green-900 mb-4 bg-clip-text text-transparent bg-gradient-to-r from-green-800 to-green-600 animate-slideIn">
          Contact Us
        </h1>
        <p class="text-lg text-black animate-fadeIn">
          We are always happy to hear from parents, guardians, and visitors.
          Reach out for enquiries, admissions, or general information.
        </p>
      </div>
    </section>
    ...
    <section class="w-full bg-green-900 text-white py-6 overflow-hidden">
      <div class="text-center py-20 px-6 max-w-4xl mx-auto opacity-0 translate-y-10 transition duration-1000 ease-out location-animate">
        ...
        <p class="text-slate-300 text-lg leading-relaxed">
          Discover an environment designed to nurture excellence, leadership, and global impact.
        </p>
      </div>
          ...
          <div class="grid md:grid-cols-4 gap-8 items-center">
            <div>
              ...
              <p class="text-sm text-slate-600 leading-relaxed">
                123 Education Avenue<br />Lagos, Nigeria
              </p>
            </div>
            <div>
              <h4 class="font-semibold text-lg mb-2">Call Us</h4>
              <p class="text-sm text-slate-600">+234 800 000 0000<br />Mon – Fri (8am – 4pm)</p>
            </div>
            <div>
              <h4 class="font-semibold text-lg mb-2">Email</h4>
              <p class="text-sm text-slate-600">info@dabsschool.com<br />admissions@dabsschool.com</p>
            </div>
            <div class="text-center md:text-right">
              <a href="https://maps.google.com" target="_blank" class="inline-block bg-slate-900 text-white px-6 py-3 rounded-full text-sm font-semibold tracking-wide hover:bg-slate-700 transition duration-300 shadow-lg">
                Get Directions →
              </a>
            </div>
          </div>
    ...
    <section class="py-16">
      <div class="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div class="space-y-4">
            <p><strong>Phone:</strong><br />07030746293<br />08030449893</p>
            <p><strong>Email:</strong><br />dabsintschool@gmail.com</p>
            <p>
              <strong>School Locations:</strong><br />
              <span class="block mt-2">
                <strong>School 1:</strong><br />
                32, Segun Falana Street, Behind MFM,<br />
                Along Mowe, Ogun State
              </span>
              <span class="block mt-3">
                <strong>School 2:</strong><br />
                Abule-Ori Road, Omu Aleku,<br />
                Mowe, Ogun State
              </span>
            </p>
        ...
        <div class="bg-white/90 backdrop-blur-md p-10 rounded-3xl shadow-2xl">
          ...
          <form id="whatsappForm" class="space-y-6">
            <input
              ...
              class="w-full px-5 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-green-400 focus:outline-none shadow-sm"
            />
            <textarea
              id="message"
            ...
            <button
              type="submit"
              class="w-full py-3 rounded-full bg-green-700 text-white font-bold hover:bg-green-800 shadow-lg transition-all duration-300 transform hover:scale-105"
            >
              Send Message
            </button>
          </form>
    ...
    <a
      href="https://wa.me/2348030449893"
      target="_blank"
      class="fixed bottom-6 right-6 bg-green-600 hover:bg-green-700 text-white p-4 rounded-full shadow-lg flex items-center justify-center"
