    ...
    >
      ...
      <div class="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <p class="text-lg md:text-xl max-w-3xl mx-auto text-green-100 mb-8">
          Join a school committed to academic excellence, strong moral values,
          leadership development, and global competitiveness.
        </p>
        <div class="flex flex-col sm:flex-row justify-center gap-4">
          <a
            href="contact.php"
            class="bg-white text-green-800 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg"
          >
            Apply Now
          </a>
          <a
            href="#process"
            class="border border-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-green-800 transition"
          >
    ...
    <section class="py-20 bg-white">
      <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <p class="text-lg text-gray-600 leading-relaxed">
          At Dabs Dynamic International Schools, we provide a well-rounded
          education built on discipline, integrity, innovation, and excellence.
          Since 2006, we have consistently prepared students for outstanding
      ...
      <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="space-y-8">
          <div class="flex gap-6 items-start">
            <div class="w-12 h-12 flex items-center justify-center rounded-full bg-green-700 text-white font-bold">1</div>
            <p class="text-gray-700 text-lg">Visit the school campus for inquiries and registration.</p>
          </div>
          <div class="flex gap-6 items-start">
            <div class="w-12 h-12 flex items-center justify-center rounded-full bg-green-700 text-white font-bold">2</div>
            <p class="text-gray-700 text-lg">Obtain and complete the official admission form.</p>
          </div>
          <div class="flex gap-6 items-start">
            <div class="w-12 h-12 flex items-center justify-center rounded-full bg-green-700 text-white font-bold">3</div>
            <p class="text-gray-700 text-lg">Submit required documents and attend entrance assessment.</p>
          </div>
          <div class="flex gap-6 items-start">
            <div class="w-12 h-12 flex items-center justify-center rounded-full bg-green-700 text-white font-bold">4</div>
        ...
        <div class="space-y-4">
          <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <button class="w-full flex justify-between items-center px-6 py-4 text-left faq-btn font-semibold text-green-800 hover:bg-green-50 transition duration-300">
              ...
              <svg class="faq-icon w-5 h-5 text-green-700 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
              </svg>
            </button>
            <div class="faq-content px-6 py-4 text-gray-700 hidden">
              Creche & Nursery: 2–5 years, Primary: 6–11 years, Secondary: 12–17 years.
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="faq-content px-6 py-4 text-gray-700 hidden">
              Yes, scholarships are available for outstanding students. Contact the school for eligibility and application details.
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="faq-content px-6 py-4 text-gray-700 hidden">
              Currently, we accept documents in person. Online submission may be available in future updates.
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="faq-content px-6 py-4 text-gray-700 hidden">
              Contact our admissions office via phone or email to schedule a tour of our facilities.
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="bg-green-800 py-20 text-white text-center">
      <div class="max-w-3xl mx-auto px-6">
        ...
        <p class="text-green-200 mb-8 text-lg">
          Enrollment spaces are limited. Begin the admission process now and
          give your child the advantage of excellence.
        </p>
        <a
          href="contact.php"
          class="inline-block bg-white text-green-800 px-10 py-4 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg"
        >
          Start Application
        </a>
      </div>
