...
function img($images, $key, $fallback = '') {
    $path = $images[$key] ?? $fallback;
    if (!$path) return '';
    // Cache-bust so replaced images show immediately
    return htmlspecialchars($path) . '?v=' . time();
}
?>
<!doctype html>
<html lang="en">
  ...
  <body class="font-sans text-gray-800">
    ...
    <!-- HERO (Dynamic: academics_hero) -->
    <section class="relative h-[70vh] flex items-center justify-center text-center text-white overflow-hidden">
      <img src="<?= img($images, 'academics_hero', 'hero-academics.jpg') ?>" class="absolute inset-0 w-full h-full object-cover" alt="Students in classroom"/>
      <div class="absolute inset-0 bg-gradient-to-r from-green-900/80 to-green-800/70"></div>
      <div class="relative z-10 px-6 max-w-4xl">
        <h1 class="text-4xl md:text-6xl font-bold leading-tight mb-6 animate-fadeIn">Academic Excellence from Foundation to Leadership</h1>
        <p class="text-lg md:text-xl text-green-100 max-w-2xl mx-auto mb-8 animate-slideUp">At Dabs Dynamic International Schools, we nurture disciplined, confident, and globally competitive students through structured academics and moral guidance.</p>
        <a href="admissions.php" class="inline-block bg-white text-green-900 px-10 py-4 rounded-xl font-semibold shadow-lg hover:scale-105 transition duration-300">Explore Admissions</a>
      </div>
    </section>

    <!-- ACADEMIC LEVELS — 3 icon cards matching design -->
    <section class="py-24 bg-gray-50">
      <div class="max-w-4xl mx-auto px-6 text-center mb-16">
        ...
        <p class="text-gray-600 text-lg">Structured programs designed to build intellectual capacity, discipline, leadership, and innovation.</p>
      </div>
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-8">
        <!-- Creche & Nursery -->
        <div class="bg-white rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 transition duration-300 border-t-4 border-green-700 p-8">
          <div class="text-5xl mb-5">📘</div>
          <h3 class="text-xl font-semibold text-green-900 mb-3">Creche & Nursery</h3>
          <p class="text-gray-600 leading-relaxed">Foundational literacy, numeracy, creativity, and social development in a safe and stimulating environment.</p>
        </div>
        <!-- Primary School -->
        <div class="bg-white rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 transition duration-300 border-t-4 border-green-700 p-8">
          <div class="text-5xl mb-5">📚</div>
          <h3 class="text-xl font-semibold text-green-900 mb-3">Primary School</h3>
          <p class="text-gray-600 leading-relaxed">Comprehensive curriculum including English, Mathematics, Science, ICT, and Moral Training.</p>
        </div>
        <!-- Secondary School -->
        <div class="bg-white rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 transition duration-300 border-t-4 border-green-700 p-8">
          <div class="text-5xl mb-5">🎓</div>
          <h3 class="text-xl font-semibold text-green-900 mb-3">Secondary School</h3>
          <p class="text-gray-600 leading-relaxed">Advanced academics, leadership development, and preparation for internal and external examinations.</p>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-white">
      <div class="max-w-6xl mx-auto px-6 text-center mb-14">
        ...
        <p class="text-gray-600 max-w-2xl mx-auto">A balanced blend of academic excellence, innovation, moral training, and leadership development.</p>
      </div>
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10">
        <div class="flex items-start space-x-4"><div class="text-3xl text-green-700">💻</div><div><h4 class="font-semibold text-green-900">ICT Integration</h4><p class="text-gray-600 text-sm">Technology-driven learning at all academic levels.</p></div></div>
        <div class="flex items-start space-x-4"><div class="text-3xl text-green-700">🧠</div><div><h4 class="font-semibold text-green-900">Critical Thinking</h4><p class="text-gray-600 text-sm">Problem-solving and analytical skills development.</p></div></div>
        <div class="flex items-start space-x-4"><div class="text-3xl text-green-700">⚖</div><div><h4 class="font-semibold text-green-900">Moral Education</h4><p class="text-gray-600 text-sm">Character formation and ethical development.</p></div></div>
        <div class="flex items-start space-x-4"><div class="text-3xl text-green-700">🏆</div><div><h4 class="font-semibold text-green-900">Sports Excellence</h4><p class="text-gray-600 text-sm">Physical development and competitive spirit.</p></div></div>
        <div class="flex items-start space-x-4"><div class="text-3xl text-green-700">🧭</div><div><h4 class="font-semibold text-green-900">Leadership Skills</h4><p class="text-gray-600 text-sm">Preparing students for future responsibility.</p></div></div>
        <div class="flex items-start space-x-4"><div class="text-3xl text-green-700">🎯</div><div><h4 class="font-semibold text-green-900">Career Guidance</h4><p class="text-gray-600 text-sm">Helping students chart successful career paths.</p></div></div>
      </div>
    </section>

    <!-- BEYOND THE CLASSROOM (Dynamic: extracurricular_sports, extracurricular_cultural, extracurricular_clubs) -->
    <section class="py-20 bg-gray-50">
      <div class="max-w-6xl mx-auto px-6 text-center mb-12">
        ...
        <p class="text-gray-600 max-w-2xl mx-auto">Developing well-rounded students through sports, arts, culture, and leadership activities.</p>
      </div>
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-8">
        <div class="relative rounded-2xl overflow-hidden shadow-lg group">
          <img src="<?= img($images, 'extracurricular_sports', 'sports.jpg') ?>" class="w-full h-64 object-cover group-hover:scale-110 transition duration-500" alt="Sports"/>
          <div class="absolute inset-0 bg-green-900/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-500"><h3 class="text-white text-xl font-semibold">Sports</h3></div>
        </div>
        <div class="relative rounded-2xl overflow-hidden shadow-lg group">
          <img src="<?= img($images, 'extracurricular_cultural', 'cultural.jpg') ?>" class="w-full h-64 object-cover group-hover:scale-110 transition duration-500" alt="Cultural Activities"/>
          <div class="absolute inset-0 bg-green-900/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-500"><h3 class="text-white text-xl font-semibold">Cultural Activities</h3></div>
        </div>
        <div class="relative rounded-2xl overflow-hidden shadow-lg group">
          <img src="<?= img($images, 'extracurricular_clubs', 'club.jpg') ?>" class="w-full h-64 object-cover group-hover:scale-110 transition duration-500" alt="Clubs & Leadership"/>
          <div class="absolute inset-0 bg-green-900/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-500"><h3 class="text-white text-xl font-semibold">Clubs & Leadership</h3></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-24 bg-gradient-to-b from-white to-green-50">
      <div class="max-w-7xl mx-auto px-6 text-center mb-16">
        ...
        <p class="text-gray-600 max-w-2xl mx-auto">Hear from members of our community about their experience at Dabs Dynamic International Schools.</p>
      </div>
    ...
    <section class="py-24 bg-green-900 text-white">
      <div class="max-w-7xl mx-auto px-6 text-center mb-16">
        ...
        <p class="text-green-200 max-w-2xl mx-auto">Our consistent academic excellence is reflected in outstanding internal and external examination results.</p>
      </div>
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10 text-center">
        <div class="bg-green-800/50 p-10 rounded-2xl shadow-xl hover:scale-105 transition duration-500"><h3 class="text-5xl font-bold mb-3">95%</h3><p class="text-green-200 font-medium">WAEC Pass Rate (5 Credits & Above)</p></div>
        <div class="bg-green-800/50 p-10 rounded-2xl shadow-xl hover:scale-105 transition duration-500"><h3 class="text-5xl font-bold mb-3">93%</h3><p class="text-green-200 font-medium">NECO Pass Rate (5 Credits & Above)</p></div>
        <div class="bg-green-800/50 p-10 rounded-2xl shadow-xl hover:scale-105 transition duration-500"><h3 class="text-5xl font-bold mb-3">90%</h3><p class="text-green-200 font-medium">University & Tertiary Admissions</p></div>
      </div>
      <div class="text-center mt-16 max-w-3xl mx-auto px-6">
        <p class="text-green-200 text-lg">Our students consistently excel in both WAEC and NECO examinations, demonstrating our commitment to academic rigor, discipline, and quality instruction.</p>
      </div>
    </section>

    <!-- TOP STUDENT SPOTLIGHT (Dynamic: top_student) -->
    <section class="py-24 bg-gray-50">
      <div class="max-w-7xl mx-auto px-6 text-center mb-16">
        <h2 class="text-4xl md:text-5xl font-bold text-green-900 mb-4">Top Student Spotlight</h2>
        <p class="text-gray-600 max-w-2xl mx-auto">Celebrating academic excellence and outstanding achievement in WAEC and NECO examinations.</p>
      </div>
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div class="relative group">
          <img src="<?= img($images, 'top_student', 'top-student.jpg') ?>" alt="Top Student" class="rounded-2xl shadow-xl w-full object-cover group-hover:scale-105 transition duration-500"/>
        ...
        <div>
          ...
          <div class="grid grid-cols-3 gap-6 mb-8 text-center">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md"><h4 class="text-3xl font-bold text-green-700">A1</h4><p class="text-sm text-gray-500">Mathematics</p></div>
            <div class="bg-white p-6 rounded-xl shadow-md"><h4 class="text-3xl font-bold text-green-700">A1</h4><p class="text-sm text-gray-500">English</p></div>
          </div>
          <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-green-700">
            <p class="text-gray-700 italic">"Dabs Dynamic gave me the discipline, academic support, and confidence I needed to excel. The teachers are exceptional."</p>
          </div>
        </div>
      </div>
    </section>

    <!-- STUDENT SLIDER (Dynamic: spotlight_student1, spotlight_student2, spotlight_student3) -->
    <section class="py-24 bg-gray-50 relative overflow-hidden">
      <div class="max-w-7xl mx-auto px-6 text-center mb-16">
        <h2 class="text-4xl md:text-5xl font-bold text-green-900 mb-4">Academic Excellence Spotlight</h2>
        <p class="text-gray-600 max-w-2xl mx-auto">Celebrating our outstanding students and their exceptional performance in national examinations.</p>
      </div>
    ...
    <section class="py-24 bg-green-900 text-white">
      ...
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10">
        <div class="bg-green-800/50 p-8 rounded-2xl shadow-xl hover:scale-105 transition duration-500"><div class="text-5xl mb-4">🏆</div><h3 class="text-xl font-semibold mb-3">Best Private School Award</h3><p class="text-green-200 text-sm">Recognized for outstanding academic performance and discipline.</p><p class="mt-3 text-green-100 font-medium">2024</p></div>
        <div class="bg-green-800/50 p-8 rounded-2xl shadow-xl hover:scale-105 transition duration-500"><div class="text-5xl mb-4">🥇</div><h3 class="text-xl font-semibold mb-3">Academic Excellence Recognition</h3><p class="text-green-200 text-sm">Awarded for exceptional WAEC & NECO results.</p><p class="mt-3 text-green-100 font-medium">2023</p></div>
        <div class="bg-green-800/50 p-8 rounded-2xl shadow-xl hover:scale-105 transition duration-500"><div class="text-5xl mb-4">🎖</div><h3 class="text-xl font-semibold mb-3">Leadership & Discipline Award</h3><p class="text-green-200 text-sm">Honored for promoting moral and ethical standards.</p><p class="mt-3 text-green-100 font-medium">2022</p></div>
      </div>
    </section>
    ...
    <section class="py-20 bg-white">
      <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <p class="text-gray-600 max-w-2xl mx-auto mb-12">Dabs Dynamic International Schools is fully approved and recognized by relevant government educational authorities.</p>
        <div class="bg-gray-50 p-10 rounded-2xl shadow-lg max-w-4xl mx-auto">
          <div class="flex flex-col md:flex-row items-center justify-center gap-10">
            ...
            <div class="text-left max-w-xl">
              ...
              <p class="text-gray-600 leading-relaxed">Our institution operates under full government authorization, ensuring compliance with national academic standards, curriculum guidelines, and examination regulations.</p>
    ...
    <section class="py-24 bg-green-900 text-white">
      <div class="max-w-6xl mx-auto px-6 text-center mb-16">
        ...
        <p class="text-green-200 max-w-2xl mx-auto">We maintain structured academic hours that promote discipline and excellence.</p>
      </div>
      <div class="max-w-5xl mx-auto bg-white text-gray-800 rounded-2xl shadow-2xl p-12">
        <div class="space-y-8">
          <div class="flex justify-between items-center border-b pb-6"><h3 class="text-2xl font-semibold text-green-800">Monday – Thursday</h3><span class="text-xl font-bold">8:00 AM – 3:00 PM</span></div>
          <div class="flex justify-between items-center"><h3 class="text-2xl font-semibold text-green-800">Friday</h3><span class="text-xl font-bold">8:00 AM – 1:00 PM</span></div>
        </div>
      </div>
    </section>
    ...
    <section class="bg-green-900 text-white py-6">
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-20">
          ...
          <a href="admissions.php" class="inline-block bg-gradient-to-r from-green-600 to-green-800 text-white px-12 py-4 rounded-xl font-semibold text-lg shadow-lg hover:scale-105 transition-transform duration-300">Begin Admission Process</a>
        </div>
          ...
          <div>
            ...
            <div class="flex space-x-4 justify-center">
              ...
              <a href="#" class="w-11 h-11 flex items-center justify-center rounded-xl bg-gradient-to-tr from-[#feda75] via-[#d62976] to-[#4f5bd5] hover:opacity-90 transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 fill-white" viewBox="0 0 24 24"><path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm5 4a5 5 0 110 10 5 5 0 010-10zm6.5-.75a1.25 1.25 0 110 2.5 1.25 1.25 0 010-2.5z"/></svg>
              </a>
              <a href="#" class="w-11 h-11 flex items-center justify-center rounded-xl bg-[#1877F2] hover:opacity-90 transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 fill-white" viewBox="0 0 24 24"><path d="M22 12a10 10 0 10-11.63 9.87v-6.99H7.9V12h2.47V9.8c0-2.43 1.45-3.78 3.68-3.78 1.07 0 2.18.19 2.18.19v2.4h-1.23c-1.21 0-1.59.75-1.59 1.52V12h2.71l-.43 2.88h-2.28v6.99A10 10 0 0022 12z"/></svg>
              </a>
            </div>
          </div>
        </div>
