  ...
  <body class="font-sans text-gray-800">
    ...
    <section class="bg-green-900 text-white py-24 text-center">
      <div class="max-w-4xl mx-auto px-6">
        ...
        <p class="text-lg text-green-200">
          Established in 2006, we are committed to raising disciplined,
          confident, and academically excellent leaders for a global future.
        </p>
      </div>
    </section>
    ...
    <section class="py-20 bg-white">
      <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <p class="text-gray-700 leading-relaxed">
          Dabs Dynamic International Schools was founded on the principle of
          <strong>"Knowledge cum Discipline."</strong> Since 2006, we have
          remained dedicated to restoring the high educational standards of
          excellence while integrating modern teaching methodologies that
          prepare students for global relevance.
        </p>
      </div>
    </section>
    ...
    <section class="py-20 bg-green-50">
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <p class="text-gray-700 leading-relaxed">
            Our mission is to recapture the high educational standards of the
            past by assembling competent, disciplined, and dedicated educators
            who deliver engaging, activity-based lessons that prioritize the
    ...
    <section class="py-20 bg-white">
      <div class="max-w-6xl mx-auto px-6 text-center">
        <h2 class="text-3xl font-bold text-green-900 mb-12">
          Our Core Values (I.T.A.C.E)
        </h2>

        <div class="grid md:grid-cols-5 gap-8">
          <div class="bg-green-50 p-6 rounded-xl shadow-md hover:shadow-lg transition">
            <h3 class="font-bold text-green-900 mb-2">Integrity</h3>
            <p class="text-sm text-gray-600">Upholding honesty and strong moral principles.</p>
          </div>
          <div class="bg-green-50 p-6 rounded-xl shadow-md hover:shadow-lg transition">
            <h3 class="font-bold text-green-900 mb-2">Teamwork</h3>
            <p class="text-sm text-gray-600">Collaborating to achieve shared success.</p>
          </div>
          <div class="bg-green-50 p-6 rounded-xl shadow-md hover:shadow-lg transition">
            <h3 class="font-bold text-green-900 mb-2">Accountability</h3>
            <p class="text-sm text-gray-600">Taking responsibility for actions and outcomes.</p>
          </div>
          <div class="bg-green-50 p-6 rounded-xl shadow-md hover:shadow-lg transition">
            <h3 class="font-bold text-green-900 mb-2">Commitment</h3>
            <p class="text-sm text-gray-600">Dedicated to excellence in every task.</p>
          </div>
          <div class="bg-green-50 p-6 rounded-xl shadow-md hover:shadow-lg transition">
            <h3 class="font-bold text-green-900 mb-2">Effectiveness</h3>
            <p class="text-sm text-gray-600">Delivering measurable and impactful results.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="space-y-8 text-gray-700 leading-relaxed">
          <div class="flex items-start gap-4" data-aos="fade-right">
            ...
            <p>
              Structured routines and supervised learning create an orderly
              environment where students develop responsibility and self-control.
            </p>
          </div>
          ...
          <div class="flex items-start gap-4" data-aos="fade-right" data-aos-delay="150">
            ...
            <p>
              Respect, punctuality, accountability, and proper conduct are
              emphasized daily through guided mentorship.
            </p>
          </div>
          ...
          <div class="flex items-start gap-4" data-aos="fade-right" data-aos-delay="300">
            ...
            <p>
              We aim to produce morally grounded, confident, and socially
        ...
        <div class="grid md:grid-cols-4 gap-10 text-center">
          <div data-aos="fade-up" data-aos-delay="0">
            <div class="flex justify-center mb-4">
              <svg class="w-10 h-10 text-green-300" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-20" data-aos="fade-up">
          ...
          <p class="text-gray-600 max-w-2xl mx-auto">
            Our leadership team is dedicated to academic excellence, moral
            discipline, and the holistic development of every student.
          </p>
        </div>

        <div class="grid md:grid-cols-2 gap-16">
          <div class="group bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)]" data-aos="fade-up" data-aos-delay="0">
            <div class="overflow-hidden">
              <img src="images/proprietor.jpg" class="w-full h-[400px] object-cover transition-transform duration-700 group-hover:scale-105" alt="Proprietor" />
            </div>
            <div class="p-8">
              ...
              <p class="text-gray-700 leading-relaxed">
                As Founder and Director, he provides strategic leadership
                focused on academic mastery, discipline, and institutional
                growth. His commitment ensures students graduate confident and
          ...
          <div class="group bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)]" data-aos="fade-up" data-aos-delay="200">
            <div class="overflow-hidden">
              <img src="images/proprietress.jpg" class="w-full h-[400px] object-cover transition-transform duration-700 group-hover:scale-105" alt="Proprietress" />
            </div>
            <div class="p-8">
              ...
              <p class="text-gray-700 leading-relaxed">
                She oversees student welfare and moral development, ensuring a
                disciplined yet nurturing environment that supports holistic
          ...
          <div class="group bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)]" data-aos="fade-up" data-aos-delay="400">
            <div class="overflow-hidden">
              <img src="images/headteacher.jpg" class="w-full h-[400px] object-cover transition-transform duration-700 group-hover:scale-105" alt="Headteacher" />
            </div>
            <div class="p-8">
              <h3 class="text-2xl font-bold text-green-900">Mrs. [Headteacher Name]</h3>
              <p class="text-green-700 font-semibold mb-4">Headteacher</p>
              <p class="text-gray-700 leading-relaxed">
                Responsible for academic operations and curriculum supervision,
                ensuring structured delivery and measurable student achievement.
              </p>
            </div>
          </div>
          ...
          <div class="group bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)]" data-aos="fade-up" data-aos-delay="600">
            <div class="overflow-hidden">
              <img src="images/administrator.jpg" class="w-full h-[400px] object-cover transition-transform duration-700 group-hover:scale-105" alt="Administrator" />
            </div>
            <div class="p-8">
              <h3 class="text-2xl font-bold text-green-900">Mr./Mrs. [Administrator Name]</h3>
              <p class="text-green-700 font-semibold mb-4">School Administrator</p>
              <p class="text-gray-700 leading-relaxed">
                Oversees operational systems, parent engagement, and
                institutional coordination that sustain excellence.
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="py-20 bg-green-50">
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 gap-12 text-gray-700">
          <div data-aos="fade-up" data-aos-delay="0">
            <h3 class="font-semibold text-green-800 mb-2 flex items-center gap-2">📘 Structured Curriculum</h3>
            <p>Lessons follow approved standards supported by continuous assessment.</p>
          </div>
          <div data-aos="fade-up" data-aos-delay="150">
            <h3 class="font-semibold text-green-800 mb-2 flex items-center gap-2">📝 Exam Preparation</h3>
            <p>Revision programs and targeted support ensure strong performance.</p>
          </div>
          <div data-aos="fade-up" data-aos-delay="300">
            <h3 class="font-semibold text-green-800 mb-2 flex items-center gap-2">👩🏾‍🏫 Qualified Educators</h3>
            <p>Dedicated teachers committed to measurable academic growth.</p>
          </div>
          <div data-aos="fade-up" data-aos-delay="450">
            <h3 class="font-semibold text-green-800 mb-2 flex items-center gap-2">📊 Individual Monitoring</h3>
            <p>Performance tracking ensures every student receives proper guidance.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="bg-green-900 text-white py-6">
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-20">
          ...
          <a href="admissions.php" class="inline-block bg-green-700 text-white px-10 py-4 rounded-lg font-semibold hover:bg-green-800 transition duration-300 shadow-md">
